...
export default function MeSettingsScreen({ onNavigateSub, isDarkMode }: MeSettingsProps) {
  ...
  return (
    <ScrollView style={[styles.masterScrollContainer, { backgroundColor: currentTheme.canvas }]} showsVerticalScrollIndicator={false}>
      <View style={[styles.settingsFixedHeader, { backgroundColor: currentTheme.bg, borderBottomColor: currentTheme.border }]}>
        <TouchableOpacity onPress={() => onNavigateSub('PROFILE')}>
          <Text style={[styles.cancelTextAction, { color: currentTheme.text }]}>‹ Back</Text>
        </TouchableOpacity>
      ...
      <View style={{ paddingHorizontal: 24, paddingTop: 10 }}>
        ...
        <Text style={[styles.headline, { color: currentTheme.text }]}>Account & model.</Text>
        ...
        <View style={[styles.settingsOptionsCardGrid, { backgroundColor: currentTheme.bg, borderColor: currentTheme.border }]}>
          <View style={[styles.switchSettingCardRow, { borderBottomColor: currentTheme.border }]}>
            <Text style={[styles.settingCardMainTitle, { color: currentTheme.text }]}>Cascade threshold</Text>
            <Text style={styles.valueConstantLabel}>0.80</Text>
          </View>
          
          <View style={[styles.switchSettingCardRow, { borderBottomColor: currentTheme.border }]}>
            <Text style={[styles.settingCardMainTitle, { color: currentTheme.text }]}>Run Deep Brain over cellular</Text>
          ...
          <View style={[styles.switchSettingCardRow, { borderBottomColor: currentTheme.border }]}>
            <Text style={[styles.settingCardMainTitle, { color: currentTheme.text }]}>Auto-flag deepfakes to feed</Text>
          ...
          <View style={[styles.switchSettingCardRow, { borderBottomWidth: 0, paddingTop: 4 }]}>
            <Text style={[styles.settingCardMainTitle, { color: currentTheme.text }]}>Lip-ROI quality</Text>
        ...
        <View style={[styles.settingsOptionsCardGrid, { backgroundColor: currentTheme.bg, borderColor: currentTheme.border }]}>
          ...
          <View style={[styles.switchSettingCardRow, { borderBottomWidth: 0, paddingTop: 4 }]}>
            <Text style={[styles.settingCardMainTitle, { color: currentTheme.text }]}>Share anonymous metrics</Text>
        ...
        <View style={[styles.settingsOptionsCardGrid, { backgroundColor: currentTheme.bg, borderColor: currentTheme.border }]}>
          <View style={[styles.switchSettingCardRow, { borderBottomColor: currentTheme.border }]}>
            <Text style={[styles.settingCardMainTitle, { color: currentTheme.text }]}>Fast Brain</Text>
            <Text style={styles.valueConstantLabel}>v2.4.1 - current</Text>
          </View>
          <View style={[styles.switchSettingCardRow, { borderBottomWidth: 0 }]}>
            <Text style={[styles.settingCardMainTitle, { color: currentTheme.text }]}>OTA channel</Text>
...
const styles = StyleSheet.create({
  masterScrollContainer: { flex: 1 },
  settingsFixedHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 24, paddingTop: 50, paddingBottom: 15, borderBottomWidth: 1 },
  cancelTextAction: { fontSize: 14, fontWeight: '600' },
  ...
  headline: { fontSize: 26, fontWeight: '700', marginTop: 6, marginBottom: 25 },
  ...
  settingsOptionsCardGrid: { borderRadius: 14, paddingHorizontal: 16, borderWidth: 1, marginBottom: 20 },
